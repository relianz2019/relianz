...
const (
	...
	ethVersion = 63 // equivalent rlz version for the downloader
...
// NewProtocolManager returns a new relianz sub protocol manager. The Relianz sub protocol manages peers capable
// with the relianz network.
...
// NodeInfo represents a short summary of the Relianz sub-protocol metadata
// known about the host peer.
type NodeInfo struct {
	Network    uint64              `json:"network"`    // Relianz network ID (1=Frontier, 2=Morden, Ropsten=3, Rinkeby=4)
