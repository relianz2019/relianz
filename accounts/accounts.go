...
// Package accounts implements high level Relianz account management.
package accounts
...
// Account represents an Relianz account located at a specific location defined
// by the optional URL field.
type Account struct {
	Address common.Address `json:"address"` // Relianz account address derived from the key
...
type Wallet interface {
	...
	// chain state reader.
	SelfDerive(base DerivationPath, chain relianz.ChainStateReader)
