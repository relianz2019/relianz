...
var ProtocolName = "rlz"

// ProtocolVersions are the upported versions of the rlz protocol (first is primary).
var ProtocolVersions = []uint{rlz63, rlz62}
...
// rlz protocol message codes
const (
	// Protocol messages belonging to rlz/62
	StatusMsg          = 0x00
	...
	// Protocol messages belonging to rlz/63
	GetNodeDataMsg = 0x0d
	NodeDataMsg    = 0x0e
	GetReceiptsMsg = 0x0f
	ReceiptsMsg    = 0x10
