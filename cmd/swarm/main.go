...
import (
	...
	"github.com/relianz2019/relianz/swarm"
	bzzapi "github.com/relianz2019/relianz/swarm/api"
	swarmmetrics "github.com/relianz2019/relianz/swarm/metrics"
...
var (
	...
	SwarmSwapAPIFlag = cli.StringFlag{
		Name:   "swap-api",
		Usage:  "URL of the Relianz API provider to use to settle SWAP payments",
...
// This init function sets defaults so cmd/swarm can run alongside rlz.
func init() {
...
var app = utils.NewApp(gitCommit, "Relianz Swarm")

// This init function creates the cli.App.
func init() {
	app.Action = bzzd
	app.HideVersion = true // we have a command to print the version
	app.Copyright = "Copyright 2013-2016 The go-relianz Authors"
...
func bzzd(ctx *cli.Context) error {
	...
	//rlz only supports --datadir via command line
	//in order to be consistent within swarm, if we pass --datadir via environment variable
	//or via config file, we get the same directory for rlz and swarm
	if _, err := os.Stat(bzzconfig.Path); err == nil {
		cfg.DataDir = bzzconfig.Path
	}
	//setup the relianz node
	...
	//register BZZ as node.Service in the relianz node
...
func registerBzzService(bzzconfig *bzzapi.Config, ctx *cli.Context, stack *node.Node) {
	...
	//register within the relianz node
