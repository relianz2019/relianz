...
// Whisper represents a dark communication interface through the Relianz
...
// New creates a Whisper client ready to communicate through the Relianz P2P network.
