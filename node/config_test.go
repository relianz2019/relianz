...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "rlz.ipc", false, filepath.Join(os.TempDir(), "rlz.ipc")},
		{"data", "rlz.ipc", false, "data/rlz.ipc"},
		{"data", "./rlz.ipc", false, "./rlz.ipc"},
		{"data", "/rlz.ipc", false, "/rlz.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "rlz.ipc", true, `\\.\pipe\rlz.ipc`},
		{"data", "rlz.ipc", true, `\\.\pipe\rlz.ipc`},
		{"data", `\\.\pipe\rlz.ipc`, true, `\\.\pipe\rlz.ipc`},
	}
