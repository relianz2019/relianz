...
type downloadTester struct {
	...
	stateDb rlzdb.Database // Database used by the tester for syncing from peers
	peerDb  rlzdb.Database // Database of the peers containing all data
...
func newTester() *downloadTester {
	...
	tester.stateDb = rlzdb.NewMemDatabase()
...
func (dl *downloadTester) makeChain(n int, seed byte, parent *types.Block, parentReceipts types.Receipts, heavy bool) ([]common.Hash, map[common.Hash]*types.Header, map[common.Hash]*types.Block, map[common.Hash]types.Receipts) {
	...
	blocks, receipts := core.GenerateChain(params.TestChainConfig, parent, rlzash.NewFaker(), dl.peerDb, n, func(i int, block *core.BlockGen) {
...
// RequestBodies constructs a getBlockBodies mrlzod associated with a particular
...
// RequestReceipts constructs a getReceipts mrlzod associated with a particular
// peer in the download tester. The returned function can be used to retrieve
...
// RequestNodeData constructs a getNodeData mrlzod associated with a particular
// peer in the download tester. The returned function can be used to retrieve
