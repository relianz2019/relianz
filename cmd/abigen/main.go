...
import (
	...
	"github.com/relianz2019/relianz/common/compiler"
)

var (
	abiFlag = flag.String("abi", "", "Path to the Relianz contract ABI json to bind")
	binFlag = flag.String("bin", "", "Path to the Relianz contract bytecode (generate deploy method)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the Relianz contract Solidity source to build and bind")
