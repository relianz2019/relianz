...
type Context struct {
	...
	// sufficient rlz to transfer the value
	CanTransfer CanTransferFunc
	// Transfer transfers rlz from one account to the other
...
// EVM is the Relianz Virtual Machine base object and provides
...
type EVM struct {
	...
	// evm.
	vmConfig Config
	// global (to this context) relianz virtual machine
