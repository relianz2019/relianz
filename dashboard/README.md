## Go Relianz Dashboard

The dashboard is a data visualizer integrated into rlz, intended to collect and visualize useful information of an Relianz node. It consists of two parts:
...
As the dashboard depends on certain NPM packages (which are not included in the `go-relianz` repo), these need to be installed first:
...
```
$ rlz --dashboard --vmodule=dashboard=5
