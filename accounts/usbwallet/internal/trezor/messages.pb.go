...
const (
	...
	MessageType_MessageType_RelianzGetAddress       MessageType = 56
	MessageType_MessageType_RelianzAddress          MessageType = 57
	MessageType_MessageType_RelianzSignTx           MessageType = 58
	MessageType_MessageType_RelianzTxRequest        MessageType = 59
	MessageType_MessageType_RelianzTxAck            MessageType = 60
	...
	MessageType_MessageType_RelianzSignMessage      MessageType = 64
	MessageType_MessageType_RelianzVerifyMessage    MessageType = 65
	MessageType_MessageType_RelianzMessageSignature MessageType = 66
...
var MessageType_name = map[int32]string{
	...
	56:  "MessageType_RelianzGetAddress",
	57:  "MessageType_RelianzAddress",
	58:  "MessageType_RelianzSignTx",
	59:  "MessageType_RelianzTxRequest",
	60:  "MessageType_RelianzTxAck",
	61:  "MessageType_GetECDHSessionKey",
	62:  "MessageType_ECDHSessionKey",
	63:  "MessageType_SetU2FCounter",
	64:  "MessageType_RelianzSignMessage",
	65:  "MessageType_RelianzVerifyMessage",
	66:  "MessageType_RelianzMessageSignature",
...
var MessageType_value = map[string]int32{
	...
	"MessageType_RelianzGetAddress":       56,
	"MessageType_RelianzAddress":          57,
	"MessageType_RelianzSignTx":           58,
	"MessageType_RelianzTxRequest":        59,
	"MessageType_RelianzTxAck":            60,
	"MessageType_GetECDHSessionKey":        61,
	"MessageType_ECDHSessionKey":           62,
	"MessageType_SetU2FCounter":            63,
	"MessageType_RelianzSignMessage":      64,
	"MessageType_RelianzVerifyMessage":    65,
	"MessageType_RelianzMessageSignature": 66,
...
// *
// Request: Ask device for Relianz address corresponding to address_n path
// @next PassphraseRequest
// @next RelianzAddress
// @next Failure
type RelianzGetAddress struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	ShowDisplay      *bool    `protobuf:"varint,2,opt,name=show_display,json=showDisplay" json:"show_display,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *RelianzGetAddress) Reset()                    { *m = RelianzGetAddress{} }
func (m *RelianzGetAddress) String() string            { return proto.CompactTextString(m) }
func (*RelianzGetAddress) ProtoMessage()               {}
func (*RelianzGetAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{22} }

func (m *RelianzGetAddress) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *RelianzGetAddress) GetShowDisplay() bool {
	if m != nil && m.ShowDisplay != nil {
		return *m.ShowDisplay
	}
	return false
...
// *
// Response: Contains an Relianz address derived from device private seed
// @prev RelianzGetAddress
type RelianzAddress struct {
	Address          []byte `protobuf:"bytes,1,req,name=address" json:"address,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *RelianzAddress) Reset()                    { *m = RelianzAddress{} }
func (m *RelianzAddress) String() string            { return proto.CompactTextString(m) }
func (*RelianzAddress) ProtoMessage()               {}
func (*RelianzAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{24} }

func (m *RelianzAddress) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
// @next PassphraseRequest
// @next PinMatrixRequest
// @next RelianzTxRequest
// @next Failure
type RelianzSignTx struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Nonce            []byte   `protobuf:"bytes,2,opt,name=nonce" json:"nonce,omitempty"`
...
func (m *RelianzSignTx) Reset()                    { *m = RelianzSignTx{} }
func (m *RelianzSignTx) String() string            { return proto.CompactTextString(m) }
func (*RelianzSignTx) ProtoMessage()               {}
func (*RelianzSignTx) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{49} }

func (m *RelianzSignTx) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *RelianzSignTx) GetNonce() []byte {
	if m != nil {
		return m.Nonce
	}
	return nil
...
func (m *RelianzSignTx) GetGasPrice() []byte {
	if m != nil {
		return m.GasPrice
	}
	return nil
...
func (m *RelianzSignTx) GetGasLimit() []byte {
	if m != nil {
		return m.GasLimit
	}
	return nil
...
func (m *RelianzSignTx) GetTo() []byte {
	if m != nil {
		return m.To
	}
	return nil
...
func (m *RelianzSignTx) GetValue() []byte {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *RelianzSignTx) GetDataInitialChunk() []byte {
	if m != nil {
...
func (m *RelianzSignTx) GetDataLength() uint32 {
...
func (m *RelianzSignTx) GetChainId() uint32 {
...
func (m *RelianzTxRequest) Reset()                    { *m = RelianzTxRequest{} }
func (m *RelianzTxRequest) String() string            { return proto.CompactTextString(m) }
func (*RelianzTxRequest) ProtoMessage()               {}
func (*RelianzTxRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{50} }

func (m *RelianzTxRequest) GetDataLength() uint32 {
	if m != nil && m.DataLength != nil {
		return *m.DataLength
	}
	return 0
...
func (m *RelianzTxRequest) GetSignatureV() uint32 {
...
func (m *RelianzTxRequest) GetSignatureR() []byte {
	if m != nil {
		return m.SignatureR
	}
	return nil
...
func (m *RelianzTxRequest) GetSignatureS() []byte {
	if m != nil {
		return m.SignatureS
	}
	return nil
...
// @prev RelianzTxRequest
// @next RelianzTxRequest
type RelianzTxAck struct {
	DataChunk        []byte `protobuf:"bytes,1,opt,name=data_chunk,json=dataChunk" json:"data_chunk,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *RelianzTxAck) Reset()                    { *m = RelianzTxAck{} }
func (m *RelianzTxAck) String() string            { return proto.CompactTextString(m) }
func (*RelianzTxAck) ProtoMessage()               {}
func (*RelianzTxAck) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{51} }

func (m *RelianzTxAck) GetDataChunk() []byte {
	if m != nil {
		return m.DataChunk
	}
	return nil
...
// *
// Request: Ask device to sign message
// @next RelianzMessageSignature
// @next Failure
type RelianzSignMessage struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Message          []byte   `protobuf:"bytes,2,req,name=message" json:"message,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *RelianzSignMessage) Reset()                    { *m = RelianzSignMessage{} }
func (m *RelianzSignMessage) String() string            { return proto.CompactTextString(m) }
func (*RelianzSignMessage) ProtoMessage()               {}
func (*RelianzSignMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{52} }

func (m *RelianzSignMessage) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *RelianzSignMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// @next Success
// @next Failure
type RelianzVerifyMessage struct {
...
func (m *RelianzVerifyMessage) Reset()                    { *m = RelianzVerifyMessage{} }
func (m *RelianzVerifyMessage) String() string            { return proto.CompactTextString(m) }
func (*RelianzVerifyMessage) ProtoMessage()               {}
func (*RelianzVerifyMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{53} }

func (m *RelianzVerifyMessage) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *RelianzVerifyMessage) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func (m *RelianzVerifyMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// *
// Response: Signed message
// @prev RelianzSignMessage
type RelianzMessageSignature struct {
	Address          []byte `protobuf:"bytes,1,opt,name=address" json:"address,omitempty"`
	Signature        []byte `protobuf:"bytes,2,opt,name=signature" json:"signature,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *RelianzMessageSignature) Reset()                    { *m = RelianzMessageSignature{} }
func (m *RelianzMessageSignature) String() string            { return proto.CompactTextString(m) }
func (*RelianzMessageSignature) ProtoMessage()               {}
func (*RelianzMessageSignature) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{54} }

func (m *RelianzMessageSignature) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *RelianzMessageSignature) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*RelianzGetAddress)(nil), "RelianzGetAddress")
	proto.RegisterType((*Address)(nil), "Address")
	proto.RegisterType((*RelianzAddress)(nil), "RelianzAddress")
	...
	proto.RegisterType((*RelianzSignTx)(nil), "RelianzSignTx")
	proto.RegisterType((*RelianzTxRequest)(nil), "RelianzTxRequest")
	proto.RegisterType((*RelianzTxAck)(nil), "RelianzTxAck")
	proto.RegisterType((*RelianzSignMessage)(nil), "RelianzSignMessage")
	proto.RegisterType((*RelianzVerifyMessage)(nil), "RelianzVerifyMessage")
	proto.RegisterType((*RelianzMessageSignature)(nil), "RelianzMessageSignature")
