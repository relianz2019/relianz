...
// It offers only mrlzods that operates on data that can be available to anyone without security risks.
...
type SyncingResult struct {
	...
	Status  rlzereum.SyncProgress `json:"status"`
}
