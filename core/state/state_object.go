...
// stateObject represents an Relianz account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of relianz address of the account
	data     Account
	db       *StateDB
...
// Account is the Relianz consensus representation of accounts.
