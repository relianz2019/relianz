Name "rlz ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/relianz2019/relianz/issues"
!define UPDATEURL "https://github.com/relianz2019/relianz/releases"
...
Section "Rlz" GETH_IDX
  ...
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\rlz.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\rlz.exe" "attach" "" ""
  ...
  # Firewall - add rules
  SimpleFC::AdvAddRule "Rlz incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\rlz.exe" "" "" "Relianz" 30303 "" "" ""
  SimpleFC::AdvAddRule "Rlz outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\rlz.exe" "" "" "Relianz" "" 30303 "" ""
  SimpleFC::AdvAddRule "Rlz UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\rlz.exe" "" "" "Relianz" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/relianz/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "R" "HKLM" "\\.\pipe\rlz.ipc"
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\rlz.ipc"
