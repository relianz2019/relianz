...
func TestCheckCompatible(t *testing.T) {
	...
	tests := []test{
		{stored: AllRlzashProtocolChanges, new: AllRlzashProtocolChanges, head: 0, wantErr: nil},
		{stored: AllRlzashProtocolChanges, new: AllRlzashProtocolChanges, head: 100, wantErr: nil},
		{
		...
		{
			stored: AllRlzashProtocolChanges,
