...
// Package bind generates Relianz contract Go bindings.
//
// Detailed usage document and tutorial available on the go-relianz Wiki page:
// https://github.com/relianz2019/relianz/wiki/Native-DApps:-Go-bindings-to-Relianz-contracts
package bind
