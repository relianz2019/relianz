...
// Package chequebook package wraps the 'chequebook' Relianz smart contract.
//
// The functions in this package allow using chequebook for
// issuing, receiving, verifying cheques in rlz; (auto)cashing cheques in rlz
// as well as (auto)depositing rlz to the chequebook contract.
package chequebook
...
import (
	...
	"github.com/relianz2019/relianz/contracts/chequebook/contract"
	"github.com/relianz2019/relianz/core/types"
	"github.com/relianz2019/relianz/crypto"
	"github.com/relianz2019/relianz/log"
	"github.com/relianz2019/relianz/swarm/services/swap/swap"
)
...
// * depositing rlz to the chequebook
// * watching incoming rlz
...
// Cash cashes the cheque by sending an Relianz transaction.
